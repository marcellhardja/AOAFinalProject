...
_lr_productions = [
  ...
  ('statement -> s1 s2','statement',2,'p_statement','plyparser.py',13),
  ('statement -> empty','statement',1,'p_statement','plyparser.py',14),
  ('s1 -> var_declaration_statement','s1',1,'p_s1','plyparser.py',31),
  ('s1 -> if_expression','s1',1,'p_s1','plyparser.py',32),
  ('s1 -> io_statement','s1',1,'p_s1','plyparser.py',33),
  ('s1 -> loop_expression','s1',1,'p_s1','plyparser.py',34),
  ('s1 -> STRING SEMICOLON','s1',2,'p_s1','plyparser.py',35),
  ('s1 -> empty','s1',1,'p_s1','plyparser.py',36),
  ('s2 -> statement','s2',1,'p_s2','plyparser.py',46),
  ('io_statement -> CIN RIGHTSHIFT STRING SEMICOLON','io_statement',4,'p_io_statement','plyparser.py',56),
  ('io_statement -> COUT LEFTSHIFT STRING SEMICOLON','io_statement',4,'p_io_statement','plyparser.py',57),
  ('var_declaration_statement -> IDENTIFIER STRING SEMICOLON','var_declaration_statement',3,'p_var_declaration_statement','plyparser.py',68),
  ('loop_expression -> WHILE condition LCURLY statement RCURLY','loop_expression',5,'p_loop_expression','plyparser.py',79),
  ('loop_expression -> FOR forcondition LCURLY statement RCURLY','loop_expression',5,'p_loop_expression','plyparser.py',80),
  ('condition -> LPAR expression RPAR','condition',3,'p_condition','plyparser.py',100),
  ('forcondition -> LPAR expression SEMICOLON expression SEMICOLON expression RPAR','forcondition',7,'p_forcondition','plyparser.py',110),
  ('forcondition -> LPAR IDENTIFIER expression SEMICOLON expression SEMICOLON expression RPAR','forcondition',8,'p_forcondition','plyparser.py',111),
  ('if_expression -> IF condition LCURLY statement RCURLY else_expression','if_expression',6,'p_if_expression','plyparser.py',123),
  ('if_expression -> IF condition LCURLY statement RCURLY elseif_expression','if_expression',6,'p_if_expression','plyparser.py',124),
  ('elseif_expression -> ELSE IF condition LCURLY statement RCURLY elseif_expression','elseif_expression',7,'p_elseif_expression','plyparser.py',141),
  ('elseif_expression -> ELSE IF condition LCURLY statement RCURLY else_expression','elseif_expression',7,'p_elseif_expression','plyparser.py',142),
  ('elseif_expression -> empty','elseif_expression',1,'p_elseif_expression','plyparser.py',143),
  ('else_expression -> ELSE LCURLY statement RCURLY','else_expression',4,'p_else_expression','plyparser.py',165),
  ('else_expression -> empty','else_expression',1,'p_else_expression','plyparser.py',166),
  ('expression -> STRING','expression',1,'p_expression_string_id','plyparser.py',183),
  ('expression -> ID','expression',1,'p_expression_string_id','plyparser.py',184),
  ('expression -> empty','expression',1,'p_expression_string_id','plyparser.py',185),
  ('empty -> <empty>','empty',0,'p_empty','plyparser.py',195),
]
